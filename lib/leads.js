...
// Covers both the three-variant demo chain (generating / html_ready /
// deploying) and the production-build chain that QStash queues for the
// Telegram webhook (finishing / changing).
