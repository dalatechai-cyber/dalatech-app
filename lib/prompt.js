...
function buildSystemPrompt() {
  return [
    ...
    "- The brand primary color MUST appear in at least four roles beyond background: accent border on at least one card, hover state on buttons, focus ring on inputs/links, Font Awesome icon color OR a CSS-painted decorative shape, AND at least one piece of inline typography (a single highlighted word in the hero or a colored numeral).",
    "",
