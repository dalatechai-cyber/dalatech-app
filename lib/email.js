    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:${SURFACE};border:1px solid ${BORDER};border-radius:20px;overflow:hidden;">
          <tr>
            <td align="center" style="padding:36px 32px 24px 32px;background:${BG};border-bottom:1px solid ${BORDER};">
              <img src="${LOGO_URL}" alt="DalaTech" width="160" style="display:block;width:160px;height:auto;max-width:60%;margin:0 auto;border:0;outline:none;">
            </td>
          </tr>
          ${body}
          <tr>
